function tests = function_to_minimize_v2_test
...
function testJacobian(testCase)
    ...
    L = length(Xn);
    ftm = @(Xn) function_to_minimize_v2(Xn, previous_conditions, dt, contact_points, testCase.TestData.settings);
    ...
    expected_value = JacobianCalculator_v2(Xn, previous_conditions, dt, contact_points, testCase.TestData.settings);
